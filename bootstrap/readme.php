...
<script type="text/javascript" src="js/language/xx-XX.js"></script><!--language/calendar code-->
<link href="http://www.mpcgaming.com/sc2/styles.css" rel="stylesheet" type="text/css" />
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<link href = "bootstrap/css/bootstrap.min.css" rel="stylesheet"/>
<link rel="stylesheet" href="css/calendar.css"><!--calendar source css-->
<script src="js/jquery-1.11.1.min.js" type="text/jscript"></script>
<script src="js/bootstrap.min.js" type="text/jscript"></script>
<!-- #BeginEditable "doctitle" -->
<title>Miacro Power Clan - SC2 MPC - MPCGaming.com</title>
<!-- Miacro Power Clan - SC2 MPC - MPCGaming.com -->
<meta name="keywords" content="MPC,SC2,MPCGaming.com" />
<meta name="description" content="SC2 MPC Gaming. Tournaments, Clan wars, teaching, training, coaching." />
<!-- #EndEditable -->
</head>
<body>
<?php
...
?>
<div id="container" style="max-width: 1200px;">
<?php
...
<div id="content">
    ...
    <div class="row">
    <div class="page-header text-center">Bootstrap Calendar Read Me.MD</div>
    <small>Bootstrap Calendar
===
