...
<div class="container">	
	<div class="panel panel-default">
		...
		<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="dojoinfo">
						<div class="page-header">
							<h1 style="margin-left: 15px">
								MPC Dojo
							</h1>
							<small>
								<p>The role of the dojos are to compile information regarding the game player itself, whether, it's part of a team strategy, or for person vs person to help better the player's performance in the game that is selected. This will include maps, screen shot, video examples, and MPC team strategy guides.</p>
							</small>
						</div>
					<div class="row"><!--media-->
						<div class="media">
							<div class="media-left">
								<img src="../pics/games.png" class="img-responsive img-rounded" alt="../pics/games"  style="width: 100px; height: 100px; margin-left: 25px" />
								<ul class="list-group" style="margin-left: 25px;">
									  <li class="list-group-item list-group-item-default">Starcraft</li>
									  <li class="list-group-item list-group-item-default">Command and Conquer</li>
									  <li class="list-group-item list-group-item-default">Red Alert</li>
									  <li class="list-group-item list-group-item-default">Starcraft 2</li>
									  <li class="list-group-item list-group-item-default">League of Legends</li>
									  <li class="list-group-item list-group-item-default">Heroes of the Storm</li>
								</ul>
							</div>
							<div class="media-body">
								<div class="page-header">
									...
									<small>
										<p>A paragraph (from the Ancient Greek παράγραφος paragraphos, "to write beside" or "written beside") is a self-contained unit of a discourse in writing dealing with a particular point or idea. A paragraph consists of one or more sentences.A paragraph (from the Ancient Greek παράγραφος paragraphos, "to write beside" or "written beside") is a self-contained unit of a discourse in writing dealing with a particular point or idea. A paragraph consists of one or more sentences.A paragraph (from the Ancient Greek παράγραφος paragraphos, "to write beside" or "written beside") is a self-contained unit of a discourse in writing dealing with a particular point or idea. A paragraph consists of one or more sentences.A paragraph (from the Ancient Greek παράγραφος paragraphos, "to write beside" or "written beside") is a self-contained unit of a discourse in writing dealing with a particular point or idea. A paragraph consists of one or more sentences.</p>
									</small>					
						...
						<div class="media">
							<div class="media-left">
								<img src="../pics/games.png" class="img-responsive img-rounded media-object" alt="../pics/games" style="width: 100px; height: 100px; margin-left: 25px;" />
								<ul class="list-group" style="margin-left: 25px;"><li class="list-group-item list-group-item-default"></li><li class="list-group-item list-group-item-default"></li><li class="list-group-item list-group-item-default"></li><li class="list-group-item list-group-item-default"></li><li class="list-group-item list-group-item-default"></li></ul>
							</div>
							<div class="media-body">
								<div class="page-header">
				...
				<div role="tabpanel" class="tab-pane" id="dojorts">
				...
				<div role="tabpanel" class="tab-pane" id="dojommorpg">
					<div class="page-header text-center">
						<h1>
