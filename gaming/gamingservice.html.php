    ...
    <div id="page-content-wrapper" style="padding-top: 55px; padding-bottom: 55px;">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<small>
					<p>Search the games, and learn more about them with this page. Maybe there will be some interest in another game that MPC plays in. Find the MPC group in that game, and begin creating new friends, or learning more about that game from the MPC community.</p>
				</small>
			</div>
