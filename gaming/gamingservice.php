...
<head>
    ...
    <meta name="description" content="Multi-Player Clan - Gaming community hosting tournaments for various games including StarCraft II, Heroes of the Storm, Counter-Strike: Global Offensive.">
	...
	<div role="tabpanel">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="row">
					<center>
						<img src="../pics/gamingservices.png" alt="gamingservices.png" class="img-responsive img-rounded text-center" style="height: 100px; width: 700px;" name="top" />
					</center>
				</div>
			</div>
		</div>
		<div class="panel panel-default">
			...
			<div class="well">
				<ul id="GamingServicesTab" class="nav nav-tabs">
					<li class="active">
						<a href="#generaltab-gserv" data-toggle="tab">
						GSP(Digital Software Distributor)
						</a>
					</li>
					<li>
						<a href="#blizzardtab-gserv" data-toggle="tab">
							Blizzard 
					...
					<li>
						<a href="#valvetab-gserv" data-toggle="tab">
							Valve: 
								<span class="label label-default">
									Steam Application
								</span>
					...
					<li>
						<a href="#eagamestab-gserv" data-toggle="tab">
							EA Games: 
								<span class="label label-default"> 
									Origin Application
								</span>
					...
					<li>
						<a href="#indegamestab-gserv" data-toggle="tab">
							Independent: 
								<span class="label label-default">
									Custom Application
								</span>
			...
			<div id="GamingServicesTabContent" class="tab-content">
				<div class="tab-pane fade in active" id="generaltab-gserv" >
					<div class="panel panel-default">
						<div class="panel-heading">
			...
			<div class="tab-pane fade" id="blizzardtab-gserv">
				<div class="panel panel-default">
					<div class="panel-title">
						<h3>
							Battle.net - Blizzard Entertainment - est. 1996
						</h3>
					</div>
					<div class="panel-body">
						<div class="media">
							<div class="media-left">
								...
								<div class="row">
									...
									<ul class="nav nav-pills nav-stacked">
										...
										<a name="steaminfo"></a><!--page anchor for steam-->
								</div>
							</div>
							<div class="media-body">
								<div class="row">
								...
								<div class="row">
									...
									<small>
										<p>&ensp;&ensp;&ensp;&ensp;&ensp;Battle.net uses a centralized account system that lets players manage all of their Blizzard Entertainment games, including World of Warcraft, StarCraft II, and future games, in one place without having to remember multiple sets of login information. Once you log in through the new Battle.net desktop app, you have access to all your Blizzard games. Get in a quick World of Warcraft dungeon run with your guild, play a few league games in StarCraft II, and then head over to Diablo III and level up your barbarian without having to sign in separately each time.</p>
									</small>
								</div>
								<div class="row">
									<div class="page-header">
										...
										<a name="wowinfo"></a><!--page anchor for world of war-craft-->
									</div>
									<div class="panel-group" id="blizzardaccordion" role="tablist" aria-multiselectable="true">
										<div class="panel panel-default">
												...
												<div id="warcraftcollapse-gaming" class="panel-collapse collapse" role="tabpanel" aria-labelledby="warcraftseries-gaming">
													<div class="panel-body">					  
														<div role="tabpanel">
															<ul class="nav nav-tabs" role="tablist" id="WowListTab">
																<li role-="presentation" >
																	<a href="#wow2004tab" aria-controls="wow2004tab" role="tab" data-toggle="tab">
																		World of WarCraft 2004
																	</a>
																</li>
																<li role-="presentation" >
																	<a href="#wow2007tab" aria-controls="wow2007tab" role="tab" data-toggle="tab">
																		Burning Crusade: 2007
																	</a>
																</li>
																<li role-="presentation" >
																	<a href="#wow2008tab" aria-controls="wow2008tab" role="tab" data-toggle="tab">
																		Wrath of the Lich King: 2008
																	</a>
																</li>
																<li role-="presentation" >
																	<a href="#wow2010tab" aria-controls="wow2010tab" role="tab" data-toggle="tab">
																		Cataclysm: 2010
																	</a>
																</li>
																<li role-="presentation" >
																	<a href="#wow2012tab" aria-controls="wow2012tab" role="tab" data-toggle="tab">
																		Mists of Pandaria: 2012
																	</a>
																</li>
																<li role-="presentation" >
																	<a href="#wow2015tab" aria-controls="wow2015tab" role="tab" data-toggle="tab">
																		Warlords of Draenor: 2015
																	</a>
																</li>
																<li role-="presentation" >
																	<a href="#wowresourcetab" aria-controls="wow2015tab" role="tab" data-toggle="tab">
																		MPC WOW Dojo
																	</a>
																</li>
															</ul>
															<div class="tab-content">
																<div role="tabpanel" class="tab-pane fade in" id="wow2004tab">
																	<div class="list-group">
																	  <a href="https://us.battle.net/account/creation/wow/signup/" class="list-group-item list-group-item-default" target="_blank">
																			...
																			<p class="list-group-item-text">
																				World of Warcraft is a massively multi-player on-line role-playing game created in 2004 by Blizzard Entertainment. It is the fourth released game set in the fantasy Warcraft universe, which was first introduced by Warcraft: Orcs & Humans in 1994.
																			</p>
																	  </a>
																	</div>
																	<div class="list-group">
																...
																<div role="tabpanel" class="tab-pane fade " id="wow2007tab">
																	<div class="list-group">
																		...
																		<p class="list-group-item-text">
																			Often referred to as TBC or BC, is the first expansion pack for the MMORPG World of Warcraft.
																		</p>
																		</a>
																	</div>
																</div>
																<div role="tabpanel" class="tab-pane fade " id="wow2008tab">
																	<div class="list-group">
																		<a href="http://us.blizzard.com/en-us/games/wrath/" class="list-group-item list-group-item-default" target="_blank">
																			...
																			<p class="list-group-item-text">
																				Often referred to as WotLK or "Wrath", is the second expansion set for the Massively Multiplayer Online Role-Playing Game World of Warcraft, following The Burning Crusade.
																			</p>
																	  </a>
																	</div>
																</div>
																<div role="tabpanel" class="tab-pane fade " id="wow2010tab">
																	<div class="list-group">
																		  <a href="http://us.blizzard.com/en-us/games/cataclysm/" class="list-group-item list-group-item-default" target="_blank">
																				...
																				<p class="list-group-item-text">
																					Often referred to as Cataclysm or Cata, is the third expansion pack for the massively multiplayer online role-playing game World of Warcraft, following Wrath of the Lich King.
																				</p>
																		  </a>
																	</div>
																</div>
																<div role="tabpanel" class="tab-pane fade " id="wow2012tab">
																	<div class="list-group">
																	  <a href="http://us.blizzard.com/en-us/games/mists/" class="list-group-item list-group-item-default" target="_blank">
																			...
																			<p class="list-group-item-text">
																				Colloquially referred to as Mists or MoP, is the fourth expansion set for the massively multiplayer online role-playing game World of Warcraft, following Cataclysm.
																			</p>
																	  </a>
																	</div>
																</div>
																<div role="tabpanel" class="tab-pane fade" id="wow2015tab">
																	<div class="list-group">
																...
																<div role="tabpanel" class="tab-pane fade" id="wowresourcetab">
																	<div class="list-group">
																		<a href="http://us.battle.net/wow/en/warlords-of-draenor/" class="list-group-item list-group-item-default" target="_blank">
																			<h4 class="list-group-item-heading">
																				MPC Dojo
																			...
																			<p class="list-group-item-text">
																				Resourceful from MPC players. We always love a competitive game, therefore, we train to increase competition on anybody who wishes to learn.
																			</p>
																		</a>
																	</div>
																</div>
			...
			<div class="tab-pane fade" id="valvetab-gserv">		
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="panel-heading">
							<h3>Steam.com - Valve Corp est. 1996</h3>
						</div>
						<div class="media">
							<div class="media-body">
									<ul class="nav nav-pills">
									...
									<small>
										<p>&ensp;&ensp;&ensp;&ensp;&ensp;Steam is an Internet-based digital distribution, digital rights management (DRM), multiplayer, and social networking platform developed by Valve Corporation. Steam provides the user with installation and automatic updating of games on multiple computers, and community features such as friends lists and groups, cloud saving, and in-game voice and chat functionality. The software provides a freely available application programming interface (API) called Steamworks, which developers can use to integrate many of Steam's functions, including networking and matchmaking, in-game achievements, micro-transactions, and support for user-created content through Steam Workshop, into their products.</p>
									</small>
									<div class="page-header">
										<h4>
											Developer or Merchant of:
												<a name="counterstrikeinfo"></a>
										</h4>
									</div>
									<div class="panel-group" id="steamaccordion" role="tablist" aria-multiselectable="true">
										...
										<div class="panel panel-default">
											...
											<div id="game2collapse-gaming" class="panel-collapse collapse" role="tabpanel" aria-labelledby="game2series-gaming">
												 <div class="panel-body">
													<div class="list-group">
														<a href="http://store.steampowered.com/agecheck/app/271590/" class="list-group-item list-group-item-default" target="_blank">
															<h4 class="list-group-item-heading">
																Grand Theft Auto V
															</h4>
															<p class="list-group-item-text">Grand Theft Auto V is an open world, action-adventure video game developed by Rockstar North and published by Rockstar Games. It was released on 17 September 2013 for the PlayStation 3 and Xbox 360.</p>
														</a>
													</div>
												 </div>
											</div>
										...
										<div id="game3collapse-gaming" class="panel-collapse collapse" role="tabpanel" aria-labelledby="game3series-gaming">
											<div class="panel-body">
												<div class="list-group">
													  <a href="http://store.steampowered.com/agecheck/app/311340/" class="list-group-item list-group-item-default" target="_blank">
														<h4 class="list-group-item-heading">Metal Gear Solid V: Ground Zeroes Demo</h4>
														<p class="list-group-item-text">An Action-adventure steal video game developed by Kojima Productions, for console, and PC. A sub-series of prequels in the Metal Gear Series, taking place after Metal Gear Solid: Peace Walker. This game serves as prologue to the finalization of Metal Gear Solid: The Phantom Pain.</p>
													  </a>
												</div>
												<div class="list-group">
													  <a href="http://www.konami.jp/mgs5/tpp/certification.php5" class="list-group-item list-group-item-default" target="_blank">
														<h4 class="list-group-item-heading">Metal Gear Solid V: The Phantom Pain</h4>
														<p class="list-group-item-text">is an upcoming open world action-adventure stealth video game developed by Kojima Productions and directed, co-produced and co-written by Hideo Kojima, currently in development for the console, and PC systems. More updates to come.</p>
													  </a>
												</div>
											</div>
										</div>
			...
			<div class="tab-pane fade" id="eagamestab-gserv">
				<div class="panel panel-default">
					<div class="panel-title">
						<h3>Origin.com - EA Corp. est. 1996</h3>
					</div>
					<div class="panel-body">
						<div class="media">
							<div class="media-left">
							...
							<div class="media-body">
								<div class="row">
									 <ul class="nav nav-pills">
										...
										<div class="col-xs-6">
											<li role="presentation">
												<a type="button"  data-toggle="tooltip" data-placement="left" title="Go to Origin" href="#" target="_blank">
												<span class="glyphicon glyphicon-hdd" aria-hidden="false"></span>
												<!---->Find Players<!---->
												</a>
											</li>
								...
								<small><p>&ensp;&ensp;&ensp;&ensp;&ensp;Formally known as EA Download Manager, Origin is an on-line gaming, digital distribution, and digital rights management platformd eveloped by Electronic Arts that allows the users to purchase games on the internet for PC, and mobile platforms, and download them with the Origin Client Software. Create an Account, and begin playing with other players immediately! Good Luck Have Fun!</p></small>
									<br />
								<div class="page-header"><h4>Developed Games:<a name="simcityinfo"></a></h4></div>
									...
									<div class="panel panel-default">
										<div class="panel-heading" role="tab" id="origingame2series-gaming">
										  <h4 class="panel-title">
											<a class="collapsed" data-toggle="collapse" data-parent="#originaccordion" href="#origingame3collapse-gaming" aria-expanded="false" aria-controls="origingame3collapse-gaming">
											  Command And Conquer
											</a>
										  </h4>
										</div>
										<div id="origingame3collapse-gaming" class="panel-collapse collapse" role="tabpanel" aria-labelledby="origingame3series-gaming">
											<div class="panel-body">
												<div role="tabpanel">
													<ul class="nav nav-tabs" role="tablist">
														<li role="presentation" class="active"><a href="#cncra" data-toggle="tab" aria-controls="cncra">Red Alert </a></li>
														<li role="presentation"><a href="#cncra2" data-toggle="tab" aria-controls="cncra2">Red Alert 2</a></li>
														<li role="presentation"><a href="#cncra2yuri" data-toggle="tab" aria-controls="cncra2yuri">Red Alert 2: Yuri's Revenge</a></li>
														<li role="presentation"><a href="#cncra3" data-toggle="tab" aria-controls="cncra3">Red Alert 3</a></li>
														<li role="presentation"><a href="#cncgen" data-toggle="tab" aria-controls="cncgen">Generals</a></li>
														<li role="presentation"><a href="#cncgen2" data-toggle="tab" aria-controls="cncgen2">Generals 2</a></li>
														<li role="presentation"><a href="#cncgenzh" data-toggle="tab" aria-controls="cncgenzh">Generals: Zero Hour</a></li>
													</ul>
													<div class="tab-content">
														<div class="tab-pane fade active" id="cncra">
														<p>ra</p>
														</div>
														<div class="tab-pane fade" id="cncra2">
															<p>Red Alert 2</p>
														</div>
														<div class="tab-pane fade" id="cncra2yuri">
																RA2: Yuri's Revenge
														</div>
														<div class="tab-pane fade" id="cncra">
															Red Alert
														</div>
														<div class="tab-pane fade" id="cncra3">
															Red Alert 3
														</div>
														<div class="tab-pane fade" id="cncgen">
															Generals
														</div>
														<div class="tab-pane fade" id="cncgenzh">
															Generals: Zero Hour
														</div>
														<div class="tab-pane fade" id="cncgen2">
															Generals 2
														</div>
													</div>
												</div>
			...
			<div class="tab-pane fade" id="indegamestab-gserv">
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="panel-heading">
							<h3>
												...
												<div class="list-group">
												 ...
												 <div class="list-group">
												  <a href="http://na.leagueoflegends.com/" class="list-group-item list-group-item-default" target="_blank">
														...
														<p class="list-group-item-text">Official site. Features, media, screen shots, FAQs, and forums</p>
												  </a>
												</div>
											 </div>
										</div>
										  ...
										  <div class="panel-body">
													...
													<div class="list-group">
														  <a href="http://clashofclanspcfree.com/" class="list-group-item list-group-item-default" target="_blank">
															...
															<p class="list-group-item-text">Clash of Clans is a 2012 freemium mobile MMO strategy video game developed and published by Supercell, a video game company based in Helsinki, Finland. The game was released for iOS platforms on August 2, 2012</p>
														  </a>
													</div>
											</div>
										</div>
