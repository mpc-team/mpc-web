			...
			<div id="page-content-wrapper">
                ...
                <div class="panel-footer">
                    ...
                    <br />
                     <ul class="nav nav-pills">
						<li role="presentation">
							<a href="mailto:" title="Email Us a Request">
								<span class="glyphicon glyphicon-headphones" aria-hidden="true"></span>
									Via Email
								</a>
							</li>
						<li role="presentation">
							<a href="ventrilolive.php" title="Ventrilo Visit">
								<span class="glyphicon glyphicon-headphones" aria-hidden="true"></span>
									Via Ventrilo
								</a>
							</li>
							<li role="presentation">
							<a href="gamelist.php" title="Find us in Game">
								<span class="glyphicon glyphicon-headphones" aria-hidden="true"></span>
									Via In Game
								</a>
							</li>
							...
							<li role="presentation">
							<a href="gameservice.php" title="Connect through GSP">
								<span class="glyphicon glyphicon-headphones" aria-hidden="true"></span>
									Via GSP
							</a>
						</li>
