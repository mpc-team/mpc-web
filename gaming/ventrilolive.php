...
<body>
                                        ...
                                        <div class="modal-content">
                                            <h4 class="modal-title">Download Ventrilo</h4>
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                                <small class="pull-left"><p>Ventrilo can be used for home / personal applications like talking to friends and family, or playing organized online games where Voice Comm can make them more exciting and productive.<br />
    ...
    A Ventrilo server could be setup in order to complement a web site that has voice interaction with its creators or for communicating with other people who share a common interest.<br />
    For those people that use Windows or Linux based firewall's to connect their internal home LAN's with the Internet can setup a server on the firewall computer so that friends and family can connect to your server and talk for free.<br />
